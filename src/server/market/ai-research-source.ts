...
function buildResearchPrompt({
  ...
  return [
    ...
    "Do not give every release the same boost. Judge actual performance relative to that artist's normal audience: verified listening or view acceleration, chart strength, search lift, and sustained discussion should raise impact; weak relative performance should reduce it. Keep reach separate from reception: a poorly received viral song can have high reach and negative sentiment at the same time.",
    ...
    "Absence of recent coverage is not itself negative evidence. Report a decline only when current chart, listening, search, ticket, or sustained public-interest evidence demonstrates it.",
