...
export function UserAvatar({
  ...
  return (
    <span
      className={`${sizeClass} relative grid shrink-0 place-items-center overflow-hidden rounded-full border border-line bg-panelSoft font-semibold text-paper/75`}
