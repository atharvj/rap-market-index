      ...
      <div className="rmi-card w-full p-6">
        <div className="flex items-start gap-4">
          ...
          <div className="min-w-0">
            <p className="text-xs font-semibold uppercase tracking-wide text-brass">System notice</p>
            <h1 className="mt-2 text-2xl font-semibold">This page could not load.</h1>
            <p className="mt-3 max-w-xl text-sm leading-6 text-paper/58">
              Try this page again, or return to the market while the connection recovers.
            </p>
            {error.digest ? (
              <p className="mt-3 text-xs text-paper/38">Error reference: {error.digest}</p>
            ) : null}
          </div>
        </div>
