...
const OBSERVATION_SERIES = [
  ...
  { source: "bluesky", metric: "post_count", label: "Social post count", warningThreshold: null },
  { source: "bluesky", metric: "engagement_score", label: "Social engagement", warningThreshold: null },
  { source: "bluesky", metric: "hype_post_count", label: "Social hype posts", warningThreshold: null },
  { source: "bluesky", metric: "negative_post_count", label: "Social negative posts", warningThreshold: null },
  { source: "bluesky", metric: "catalyst_post_count", label: "Social catalyst posts", warningThreshold: null },
...
function buildWarnings({
  ...
  for (const health of observationHealth) {
    if (health.source === "listenbrainz" && !config.listenbrainzTokenConfigured) {
      continue;
    }
